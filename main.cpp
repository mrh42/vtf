...
public:
	...
	bufferSize = sizeof(struct Stuff);
        ...
        createDescriptorSet();
	fprintf(stderr, "mrh: cp\n");
        createComputePipeline();

	fprintf(stderr, "mrh: cp done\n");
	mrhInit();
	...
	for (int i = 0; i < 3000; i++) {
		...
		//gettimeofday(&t1, NULL);
		//elapsedTime = (t1.tv_sec - t2.tv_sec) * 1000.0;
		//elapsedTime += (t1.tv_usec - t2.tv_usec) / 1000.0;
		//fprintf(stdout, "cpu: %d in %f ms\n", i, elapsedTime);
